 ...
 */
function businessman_preprocess_page(&$vars) {
  ...
  foreach($gmass as $value) {
    $vars[$value] = theme_get_setting($value, 'businessman');
  }
 ...
 */
function businessman_links__system_main_menu($vars) {
 ...
 */
function businessman_links__system_top_menu($vars) {
 ...
 */
function businessman_links__system_secondary_menu(&$vars) {
 ...
 */
function businessman_get_field_value($vars, $node) {
 ...
 */
function businessman_process_html(&$vars) {
  if (module_exists('color')) {
